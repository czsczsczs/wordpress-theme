      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 text-center probootstrap-hero-text pb0 probootstrap-animate" data-animate-effect="fadeIn">
            <h1 style="padding-bottom:1rem"><span  style="font-size:7rem;font-weight:lighter;">動畫製作</span></h1>
        ...
        <div class="row probootstrap-feature-showcase marginbot">
          <div class="col-md-4 col-md-push-8 probootstrap-showcase-nav probootstrap-animate">
            ...
            <li class="active">
                <a href="#">專業動畫製作服務</a>
                <!-- <p class="ap" style="color:#a0a0a0;">根據客戶要宣傳的主題創作劇本和文案；精緻短片，盡顯創意。</p> -->
              </li>
              <li>
                <a href="#">主題創作劇本</a>
                <p class="ap" style="color:#a0a0a0;">根據客戶要宣傳的主題創作劇本和文案；精緻短片，盡顯創意。</p>
              ...
              <li>
                <a href="#">故事板確認</a>
                <p class="ap" style="color:#a0a0a0;">基於劇本做出完整故事板供您確認，事先清楚整個動畫創作思路。</p>
              </li>
              <li>
                <a href="#">繪製、配音、後期特效</a>
                <p class="ap" style="color:#a0a0a0;">我們將為您提供繪製、配音、後期特效一條龍服務。</p>
              </li>
              <!-- <li>
                <a href="#">各類宣傳屏幕動畫</a>
            ...
            <div class="probootstrap-home-showcase-wrap prs">
              <div class="probootstrap-home-showcase-inner ee">
                ...
                <div class="probootstrap-image-showcase">
                  ...
                  <li class="active">
                     <video style="width:100%;margin-top: 40px;" src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/普及科技動畫業務宣傳短片2.0.mp4" controls autoplay loop muted></video>
                  </li>
                  <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/故事策劃-1.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/gusshiban.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/配音-後期-剪輯.jpg" alt="Image" class="img-responsive"></li>
                    <!-- <li class="active"><video class="video" src="<?php //echo esc_url(home_url('/'));?>/wp-content/uploads/2022/01/1、經濟局完整版（中葡文）.mp4" controls="controls" class="img-responsive"></video></li>
                    <li><video class="video" src="<?php //echo esc_url(home_url('/'));?>wp-content/uploads/2022/01/財政局.mp4" controls="controls" class="img-responsive"></video></li>
                    <li><video class="video" src="<?php //echo esc_url(home_url('/'));?>wp-content/uploads/2022/01/让我再玩会手机2.mp4" controls="controls" class="img-responsive"></video></li>
                    <li><video class="video" src="<?php //echo esc_url(home_url('/'));?>wp-content/uploads/2022/01/大熊貓3——找親戚.mp4" controls="controls" class="img-responsive"></video></li> -->
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div class="row probootstrap-gutter60">
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeInLeft">
            <div class="service text-center">
              <div class="icon">
              <img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/扁平化風格.png">
                <!-- <i class="icon-mobile3"></i> -->
              </div>
              <div class="text">
                <h3>多樣化风格</h3>
                <p style="color:#a0a0a0;">符合現代審美視覺。</p>
              </div>  
            </div>
          </div>
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeIn">
            <div class="service text-center">
              <div class="icon">
              <img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/01/無限創意.png">
                <!-- <i class="icon-presentation"></i> -->
              </div>
              <div class="text">
                <h3>無限創意</h3>
                <p style="color:#a0a0a0;">符合多元化需求。</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeInRight">
            <div class="service text-center">
              <div class="icon">
              <img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/短平快.png">
                <!-- <i class="icon-circle-compass"></i> -->
              </div>
              <div class="text">
                <h3>短平快</h3>
                <p style="color:#a0a0a0;">適合現今傳播載體。</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeInLeft">
            <div class="service text-center">
              <div class="icon">
              <img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/01/成本可控.png">
                <!-- <i class="icon-lightbulb"></i> -->
              </div>
              <div class="text">
                <h3>成本可控</h3>
                <p style="color:#a0a0a0;">根據需求專屬定制。</p>
              </div>  
            </div>
          </div>
          ...
          <div class="col-md-8 probootstrap-animate pramat" style="position: relative;">
            <div class="probootstrap-home-showcase-wrap prs">
              <div class="probootstrap-home-showcase-inner ee">
                ...
                <div class="probootstrap-image-showcase">
                  <ul class="probootstrap-images-list">
                    <li class="active"><img src="<?php //echo esc_url(home_url('/'));?>wp-content/uploads/2022/01/5-3.jpg" alt="Image" class="img-responsive"></li>
