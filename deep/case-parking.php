      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 text-center probootstrap-hero-text pb0 probootstrap-animate" data-animate-effect="fadeIn">
            <h1 style="padding-bottom:1rem"><span  style="font-size:7rem;font-weight:lighter;">停車場管理系統</span></h1>
              ...
              <div class="probootstrap-home-showcase-inner ee">
                ...
                <div class="probootstrap-image-showcase">
                  <ul class="probootstrap-images-list">
                    <li class="active"><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/1-1.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/111-1-01.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/3.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/4-1.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/5.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/6.jpg" alt="Image" class="img-responsive"></li>
        ...
        <div class="row probootstrap-gutter60">
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeInLeft">
            <div class="service text-center">
              ...
              <div class="text">
                <h3>採用先進技術開發</h3>
                <p style="color:#a0a0a0;">採用先進的技術和設備，保<br>證系統的安全、穩定、便捷</p>
              </div>  
            </div>
          </div>
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeIn">
            <div class="service text-center">
              ...
              <div class="text">
                <h3>智慧化智能管理</h3>
                <p style="color:#a0a0a0;">提高管理的水準和效率，提<br>供優質、智能、高效的服務</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeInRight">
            <div class="service text-center">
              <div class="icon">
              <img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/3mode.png">
                <!-- <i class="icon-circle-compass"></i> -->
              </div>
              <div class="text">
                <h3>節約企業運營成本</h3>
                <p style="color:#a0a0a0;">採用合理的運營成本節約管<br>理費用支出，提高經濟效益</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 probootstrap-animate" data-animate-effect="fadeInLeft">
            <div class="service text-center">
              <div class="icon">
              <img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2022/03/4mode.png">
                <!-- <i class="icon-lightbulb"></i> -->
              </div>
              <div class="text">
                <h3>實現現代化管理</h3>
                <p style="color:#a0a0a0;">全面綜合優化，以人為本，系<br>統易學易用，實現現代化管理</p>
              </div>  
            </div>
          </div>
        </div>
